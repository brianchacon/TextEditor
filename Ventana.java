...
/*  TODO  SI HAY CAMBIOS ->{ ALERT!
        ...
        */
        ...
        if (e.getSource()==menu.abrir || e.getSource()==menu.botAbrir){
            ...
            /* retorna alguna de las siguientes constantes:
...
/*TODO  if (e.getSource()==menu.guardar || e.getSource()==menu.botGuardar){
            if(direccion == null)
                guardarArchivoNuevo();
            else
                guardar();    
        }
/*TODO  if (e.getSource()==menu.guardarComo || e.getSource()==menu.botGuardarComo){
            guardarArchivoNuevo();  
        }
        */
/*TODO*/if (e.getSource()==menu.botUndo){System.out.println("HA sido presionado: undo");}
/*TODO*/if (e.getSource()==menu.botRedo){System.out.println("HA sido presionado: redo");}
        ...
        if (e.getSource()==menu.botPDF){System.out.println("HA sido presionado: pdf");}
    }
